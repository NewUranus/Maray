...
{
    /// <summary> Receives messages from the taskbar icon through window messages of an underlying helper window. </summary>
    public class WindowMessageSink : IDisposable
    {
        ...
        /// <summary> A delegate that processes messages of the hidden native window that receives window messages. Storing this reference makes sure we don't loose our reference to the message window. </summary>
        ...
        /// <summary> Fired in case the user clicked or moved within the taskbar icon area. </summary>
        public event Action<MouseEvent> MouseEventReceived;

        /// <summary> Fired if a balloon ToolTip was either displayed or closed (indicated by the boolean flag). </summary>
        public event Action<bool> BalloonToolTipChanged;

        /// <summary> Fired if the taskbar was created or restarted. Requires the taskbar icon to be reset. </summary>
        ...
        /// <summary> Creates a new message sink that receives message from a given taskbar icon. </summary>
        ...
        /// <summary> Creates a dummy instance that provides an empty pointer rather than a real window handler. <br/> Used at design time. </summary>
        ...
        /// <summary> Creates the helper message window that is used to receive messages from the taskbar icon. </summary>
        private void CreateMessageWindow()
        {
            ...
            // Get the message used to indicate the taskbar has been restarted This is used to re-add icons when the taskbar restarts
        ...
        /// <param name="wParam"> If the version is <see cref="NotifyIconVersion.Vista"/> or higher, this parameter can be used to resolve mouse coordinates. Currently not in use. </param>
        ...
        public void Dispose()
        {
            ...
            // This object will be cleaned up by the Dispose method. Therefore, you should call GC.SuppressFinalize to take this object off the finalization queue and prevent finalization code for this object from executing a second time.
        ...
        /// <para> Important: Do not provide destructor in types derived from this class. </para>
        /// </summary>
        ~WindowMessageSink()
        {
            Dispose(false);
        ...
        /// <summary> Removes the windows hook that receives window messages and closes the underlying helper window. </summary>
